...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo pms_getFromTemplate('images/favicon2.png'); ?>">
    ...
    <div id="mainHeader">
        <div class="container-fluid">
			<div id="secondMenu">
                ...
                <div id="user-popup" class="white-popup-block mfp-hide login-box">
                            ...
                            <div class="col-xs-12">
                                <div class="login-form">
                                    <form method="post" action="<?php echo DOCBASE.$page['alias']; ?>" class="ajax-form">
                                        ...
                                        <h4 class="text-uppercase text-center pb-4">
                                                        <a href=""><span>Toursim | Login</span></a>
                                                    </h4>
                                                    <br>
                                ...
                                <div class="signup-form">
                                    <form method="post" action="<?php echo DOCBASE.$page['alias']; ?>" class="ajax-form">
                                        ...
                                        <br>
                                        <h4 class="text-uppercase text-center pb-4">
                                                        <a href=""><span>Toursim | SignUp</span></a>
                                                    </h4>
                                                    <br>
                                ...
                                <div class="pass-form">
                                    <form method="post" action="<?php echo DOCBASE.$page['alias']; ?>" class="ajax-form">
                                        ...
                                        <br>
                                        <h4 class="text-uppercase text-center pb-4">
                                                        <a href=""><span>Toursim | Forgotten password?</span></a>
                                                    </h4>
                                                    <br>
            ...
            <div class="navbar navbar-default">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo DOCBASE.trim(PMS_LANG_ALIAS, '/'); ?>" title="<?php echo $pms_homepage['title']; ?>"><img src="<?php echo pms_getFromTemplate('images/logo2.png'); ?>" alt="<?php echo PMS_SITE_TITLE; ?>"></a>
