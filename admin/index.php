                                            ...
                                            <div class="panel-heading">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9 text-right">
                                                        <div class="huge dash-txt"><?php echo $count; ?></div>
                                                        <h3 class="mt0 dash-txt"><?php echo $title; ?></h3>
                                                        <?php
                                                        if($last_date != ""){
                                                            echo "<i class=\"fas fa-fw fa-clock\"></i> <small class='dash-txt1'>".$last_date."</small>";
