...
if($pms_db !== false && pms_db_table_exists($pms_db, "pm_%") === true){
    $installed = true;
    $_SESSION['msg_notice'][] = "It seems that tourism-enjoy is already installed. Remove your former tables from your database to reinstall it <a class=\"btn btn-default\" href=\"login.php\">Log in</a>";
}
